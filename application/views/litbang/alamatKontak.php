  ...
  <hr>
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editAlamatKontak"><i class="fas fa-edit"></i> Edit Alamat & Kontak</button>
      </div> 
      <div class="card-body">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?php echo base_url(); ?>litbang/alamat_kontak" method="post" enctype="multipart/form-data">
