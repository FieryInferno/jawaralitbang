              ...
              <?php
                ...
                foreach ($bidang_penelitian as $key) { ?>
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-success" data-toggle="modal" data-target="#tambahfoto<?= $key['id_bidang_penelitian']; ?>">Edit</button>
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <form action="<?php echo base_url('litbang/bidang_penelitian/edit/' . $key['id_bidang_penelitian']); ?>" method="post" enctype="multipart/form-data">
                      ...
                      <button class="btn btn-danger" data-toggle="modal" data-target="#hapusfoto<?= $key['id_bidang_penelitian']; ?>">Hapus</button>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal">Batalkan</button>
                                <a href="<?= base_url('litbang/bidang_penelitian/hapus/' . $key['id_bidang_penelitian']); ?>" class="btn btn-success">Hapus</a>
                              </div>
                          </div>
                        </div>
                      </div>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <form action="<?php echo base_url('litbang/bidang_penelitian'); ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
                  <div class="form-group">
                    <label>Bidang Penelitian</label>
