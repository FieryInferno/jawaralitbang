<div class="container-fluid">
  <h1 class="h3 mb-2 text-gray-800">Informasi Penelitian OPD</h1>
  <hr>
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#tambahhasilpenelitianopd"><i class="fas fa-plus fa-sm"></i> Tambah Informasi Penelitian OPD</button>
    </div>
            ...
            <?php 
              ...
              foreach ($opd as $key) { ?>
                <tr>
                  ...
                  <td>
                    <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#edit<?= $key['id_penelitiopd']; ?>"><i class="fas fa-edit"></i> Edit</button>
                    ...
                    <div class="modal fade" id="edit<?= $key['id_penelitiopd']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <form action="<?= base_url('litbang/opd/edit/' .$key['id_penelitiopd']); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#hapus<?= $key['id_penelitiopd']; ?>"><i class="fas fa-trash-alt"></i> Hapus</button>
                    ...
                    <div class="modal fade" id="hapus<?= $key['id_penelitiopd']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Hapus Informasi Penelitian OPD</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-dismiss="modal">Batalkan</button>
                            <a class="btn btn-danger" href="<?= base_url('litbang/opd/hapus/' .$key['id_penelitiopd']); ?>">Hapus</a>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <div class="modal fade" id="tambahhasilpenelitianopd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?php echo base_url('litbang/opd') ?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                  <label>Nama Peneliti</label>
