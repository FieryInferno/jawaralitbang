  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      ...
      <div class="table-responsive">
        <a href="<?= base_url(); ?>litbang/lacak_penelitian" class="btn btn-primary mb-3"><i class="far fa-arrow-alt-circle-left"></i> Kembali</a>
            ...
            <?php 
              ...
              foreach ($rincian as $key) { ?>
                <tr>
                  ...
                  <td class="text-center"><img src="<?= base_url('assets/' . $key['dokumentasi_pendukung']); ?>" alt="" width="50%"></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
