<div class="container-fluid">
  <h1 class="h3 mb-2 text-gray-800">Rincian Progres</h1>
  <hr>
        ...
        <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
          <thead>
            <tr align="center">
              ...
              <th>Tanggal Terakhir Progress</th>
              <th>Aksi</th>
            </tr>
          </thead>
          <tbody>
            <?php 
              ...
              foreach ($peneliti as $key) { 
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?= base_url('bakesbangpol/rincian_progres_penelitian/' . $key['id_peneliti']); ?>" class="btn btn-primary mb-2">Rincian Progres Penelitian</a>

                    <!-- Button trigger modal -->
                    <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#kirimNotifikasi<?= $key['id_peneliti']; ?>">
                      Kirim Notifikasi
                    </button> -->
                    ...
                    <!-- <div class="modal fade" id="kirimNotifikasi<?= $key['id_peneliti']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form action="<?= base_url('bakesbangpol/kirim_notifikasi/' . $key['id_peneliti']); ?>" method="post">
