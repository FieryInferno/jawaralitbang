                ...
                foreach ($pertanyaan as $key) { ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong<?= $key['id_pertanyaan']; ?>"><i class="fas fa-reply"></i>
                        Jawab
                      </button>
                      ...
                      <div class="modal fade" id="exampleModalLong<?= $key['id_pertanyaan']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <form action="<?= base_url(); ?>bakesbangpol/pertanyaan/jawab" method="post">
                      ...
                      <!-- Button trigger modal -->
                      <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hapusPertanyaan<?= $key['id_pertanyaan']; ?>"><i class="fas fa-trash-alt"></i>
                        Hapus
                      </button>
                      ...
                      <div class="modal fade" id="hapusPertanyaan<?= $key['id_pertanyaan']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-primary" data-dismiss="modal">Batalkan</button>
                              <a href="<?= base_url('bakesbangpol/pertanyaan/hapus/' . $key['id_pertanyaan']); ?>" class="btn btn-danger">Hapus</a>
                            </div>
                          </div>
                        </div>
                      </div>
