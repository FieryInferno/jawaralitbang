          ...
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            <thead>
              <tr>
                ...
                <th class="not_mapped_style" style="text-align: center;">Gambar Alur</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <!-- <td>1</td> -->
                <td class="text-center"><img src="<?= base_url('./assets/documents/skp/skp/' . $isi); ?>" alt="" width="50%"></td>
              </tr>
            </tbody>
          </table>
          <hr>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?php echo base_url('bakesbangpol/skp/alur_permohonan'); ?>" method="post" enctype="multipart/form-data">
