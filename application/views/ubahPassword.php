  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
        ...
        <form class="login100-form validate-form flex-sb flex-w" method="post" action="<?= base_url('ubah_password/' . $token); ?>">
          <input type="hidden" name="token" value="<?= $token; ?>">
          <span class="txt1 p-b-11">
            Password Baru
          </span>
          <div class="wrap-input100 validate-input m-b-36" data-validate = "Password harus diisi">
            <input class="input100" type="password" name="password_baru">
