<body id="page-top">
  <div id="wrapper">
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('/SKP/Admin/Admin');  ?>">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseDashboard" class="collapse" aria-labelledby="headingDashboard" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('SKP/Admin/Admin'); ?>">
              <i class="fas fa-tachometer-alt"></i>
              <span class="mx-3">Dashboard SU</span>
            </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url(); ?>admin/profile">
              <i class="far fa-user"></i>
              <span class="mx-3">Profil</span>
            </a>
            <a class="collapse-item" href="<?= base_url(); ?>admin/alamat_kontak">
              <i class="far fa-address-book"></i>
              <span class="mx-3">Alamat & Kontak</span>
            </a>
            <hr>
            <h6 class="collapse-header">Hasil Litbang:</h6>
            <a class="collapse-item" href="<?php echo base_url('ELitbang/Admin/Admin/opd'); ?>">
              <i class="fas fa-users"></i>
              <span class="mx-3">OPD</span>
            </a>
            <hr>
            <h6 class="collapse-header">Publikasi:</h6>
            <a class="collapse-item" href="<?= base_url(); ?>admin/agenda_kegiatan">
              <i class="far fa-calendar-alt"></i>
              <span class="mx-3">Agenda Kegiatan</span>
            </a>
            <a class="collapse-item" href="<?= base_url('ELitbang/Admin/Admin/beritaartikel'); ?>">
              <i class="far fa-copy"></i>
              <span class="mx-3">Berita/Artikel</span>
            </a>
            <a class="collapse-item" href="<?= base_url('ELitbang/Admin/Admin/kelolafoto'); ?>">
              <i class="far fa-file-image"></i>
              <span class="mx-3">Foto Kegiatan</span>
            </a>
            <a class="collapse-item" href="<?= base_url(); ?>admin/sop_litbang">
              <i class="far fa-sticky-note"></i>
              <span class="mx-3">SOP Litbang</span>
            </a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseSKPOnline" class="collapse" aria-labelledby="headingSKPOnline" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('SKP/Admin/Admin/keloladatapemohon'); ?>">
            ...
            <h6 class="collapse-header">Pengelolaan Akun:</h6>
            <a class="collapse-item" href="<?= base_url(); ?>admin/akun_operator">
              <i class="fas fa-user-cog"></i>
              <span class="mx-3">Akun Operator</span>
            </a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('SKP/Admin/Admin/keloladokpenelitian'); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('admin/bidang_penelitian'); ?>">
          <i class="far fa-folder"></i>
            ...
            <li class="nav-item">
              ...
              <div id="collapseInformasiSKP" class="collapse" aria-labelledby="headingInformasiSKP" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                  ...
                  <a class="collapse-item" href="<?= base_url(); ?>admin/skp/apa_itu">Apa itu SKP?</a>
                  <a class="collapse-item" href="<?= base_url(); ?>admin/skp/untuk_apa">Untuk apa SKP?</a>
                  <a class="collapse-item" href="<?= base_url(); ?>admin/skp/alur_permohonan">Alur Permohonan SKP</a>
