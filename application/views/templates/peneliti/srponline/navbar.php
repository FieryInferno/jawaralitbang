          ...
          <a href="
            <?php 
              switch ($this->session->role) {
                case '2':
                  echo base_url() . 'litbang/chat';
                  break;
                case '3':
                  echo base_url() . 'bakesbangpol/chat'; 
                  break;
                case '4':
                  echo base_url() . 'peneliti/chat'; 
                  break;
            ...
            <i class="fas fa-envelope fa-fw"></i>
            <?php 
              $jumlahChat = $this->db->get_where('isi_chat', [
                'status'    => '0',
                'penerima'  => $this->session->id_user
              ])->num_rows(); 
            ?>
